                    ...
                    <div class="col-lg-12">
                        <div class="header-elements">
                            ...
                            <div class="main-menu">
                                <ul>
                                    <li><a href="/"
                                            class="plus {{ Request::is('/') ? 'active' : '' }}">Beranda</a>

                                    </li>
                                    <li><a href="/pelayanan-kami"
                                            class="plus {{ Request::is('pelayanan-kami') ? 'active' : '' }}">Pelayanan
                                            Kami</a>
                                    </li>
                                    <li><a href="/loker"
                                            class="plus {{ Request::is('loker') ? 'active' : '' }}">Lowongan
                                            Kerja</a>
                                    </li>
                                    </li>
                                    <li><a href="/tentang-kami"
                                            class="plus {{ Request::is('tentang-kami') ? 'active' : '' }}">Tentang
                                            Kami</a></li>
                                    <li><a href="/kontak-kami"
                                            class="plus {{ Request::is('kontak-kami') ? 'active' : '' }}">Kontak
                                            Kami</a></li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="mobile-sidebar mobile-sidebar1">
        ...
        <div class="mobile-nav mobile-nav1">
            ...
            <div class="allmobilesection">
                <a href="contact" class="theme-btn1">Kontak Kami <span class="arrow1"><svg
                    ...
                    <path d="M18.364 17.364L12 23.7279L5.63604 17.364C2.12132 13.8492 2.12132 8.15076 5.63604 4.63604C9.15076 1.12132 14.8492 1.12132 18.364 4.63604C21.8787 8.15076 21.8787 13.8492 18.364 17.364ZM12 15C14.2091 15 16 13.2091 16 11C16 8.79086 14.2091 7 12 7C9.79086 7 8 8.79086 8 11C8 13.2091 9.79086 15 12 15ZM12 13C10.8954 13 10 12.1046 10 11C10 9.89543 10.8954 9 12 9C13.1046 9 14 9.89543 14 11C14 12.1046 13.1046 13 12 13Z"></path>
                            ...
                            <li>
                                <div class="alamat-wrapper">
                                    ...
                                    <span>Plaza Metropolitan Blok B AL NO. 7-8<br>Jl Sultan Hasanudin Tambun -
                                        Bekasi</span>
                                </div>
                            </li>
